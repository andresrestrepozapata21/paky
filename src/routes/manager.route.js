...
/**
 * @api {POST} /manager/toPayRejectCarrier
 * @apiName paky
 * @apiGroup toPayRejectCarrier
 * @apiDescription manager toPayRejectCarrier
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/toPayRejectCarrier', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
 ...
 * @apiSuccess message and get data needed
 */
router.get('/manager/getPortfolioCarrier', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
 ...
 * @apiSuccess message and get data needed
 */
router.post('/manager/getHistory', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/getProductsByDropshipper
 * @apiName paky
 * @apiGroup getProductsByDropshipper
 * @apiDescription manager getProductsByDropshipper
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/getProductsByDropshipper', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
}, getProductsByDropshipper);
/**
 * @api {POST} /manager/addPackage
 * @apiName paky
 * @apiGroup addPackage
 * @apiDescription manager addPackage
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/addPackage', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/addProductToPackage
 * @apiName paky
 * @apiGroup addProductToPackage
 * @apiDescription manager addProductToPackage
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/addProductToPackage', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/addProduct
 * @apiName paky
 * @apiGroup addProduct
 * @apiDescription manager addProduct
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/addProduct', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/deleteProduct
 * @apiName paky
 * @apiGroup getCarriers
 * @apiDescription dropshipper getCarriers
 *
 * @apiSuccess message and get data needed
 */
router.delete('/manager/deleteProduct', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/getDetailProduct
 * @apiName paky
 * @apiGroup getCarriers
 * @apiDescription dropshipper getCarriers
 *
 * @apiSuccess message and get data needed
 */
router.post('/manager/getDetailProduct', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
...
/**
 * @api {POST} /manager/editProduct
 * @apiName paky
 * @apiGroup editProduct
 * @apiDescription manager editProduct
 *
 * @apiSuccess message and get data needed
 */
router.put('/manager/editProduct/:id_product', async (req, res, next) => {
    try {
        //Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
        const token = req.headers.authorization.split(" ")[1];
        const payload = jwt.verify(token, secret);
