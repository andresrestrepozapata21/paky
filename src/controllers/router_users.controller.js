...
export async function getPackagesCarrier(req, res) {
    ...
    try {
        ...
        const getPackagesCarrier = await Package.findAll({
            ...
            attributes: ['id_p', 'orden_p', 'name_client_p', 'phone_number_client_p', 'guide_number_p', 'status_p', 'with_collection_p', 'total_price_p', 'does_shopify_p', 'send_cost_shopify_p', 'send_priority_shopify_p', 'total_price_shopify_p',]
        });
        // logger control proccess
...
export async function getDetailAsignate(req, res) {
    ...
    try {
        ...
        const getAsignatedPackage = await Package.findAll({
            ...
            attributes: ['id_p', 'orden_p', 'name_client_p', 'phone_number_client_p', 'guide_number_p', 'status_p', 'with_collection_p', 'total_price_p', 'does_shopify_p', 'send_cost_shopify_p', 'send_priority_shopify_p', 'total_price_shopify_p', 'createdAt'],
        });
        // I call and save the result of the findAll method, which is d sequelize
        const getPackage = await Package.findAll({
            ...
            attributes: ['id_p', 'orden_p', 'name_client_p', 'phone_number_client_p', 'guide_number_p', 'status_p', 'with_collection_p', 'total_price_p', 'does_shopify_p', 'send_cost_shopify_p', 'send_priority_shopify_p', 'total_price_shopify_p', 'fk_id_destiny_city_p', 'fk_id_tp_p'],
            include: [
                {
                    model: Store,
                    where: {
        ...
        const formattedDataPackages = getPackage.map(p => {
            ...
            if (type_package == 1) {
                return {
                    ...
                    does_shopify_p: p.does_shopify_p,
                    send_cost_shopify_p: p.send_cost_shopify_p,
                    send_priority_shopify_p: p.send_priority_shopify_p,
...
export async function getInterCityPackages(req, res) {
    ...
    try {
        ...
        const getCityPackages = await Package.findAll({
            ...
            attributes: ['id_p', 'fk_id_tp_p', 'orden_p', 'guide_number_p', 'profit_carrier_inter_city_p', 'total_price_p', 'does_shopify_p', 'send_cost_shopify_p', 'send_priority_shopify_p', 'total_price_shopify_p', 'with_collection_p', 'status_p', 'direction_client_p', 'createdAt'],
            include: [
                {
                    model: Store,
                    where: {
