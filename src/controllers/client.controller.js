...
export async function getPackageGuide(req, res) {
    ...
    try {
        ...
        const getPackage = await Package.findOne({
            ...
            attributes: ['id_p', 'fk_id_tp_p', 'orden_p', 'guide_number_p', 'profit_carrier_p', 'total_price_p', 'does_shopify_p', 'send_cost_shopify_p', 'send_priority_shopify_p', 'total_price_shopify_p', 'with_collection_p', 'status_p', 'direction_client_p', 'createdAt', 'phone_number_client_p', 'name_client_p'],
            order: [
